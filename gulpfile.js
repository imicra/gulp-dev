...
var themename = 'twentytwentyone-child';
...
gulp.task('script', gulp.parallel('script:dev', 'script:jq', 'component:dev'));
gulp.task('script:min', gulp.parallel('script:min', 'component:min'));
